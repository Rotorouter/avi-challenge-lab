"""Validate avi_challenge_lab logging works."""
import mock
import avi_challenge_lab
...
def test_initialize_logging_default(get_logger, basic_cfg):
    ...
    avi_challenge_lab.log.initialize_logging()
    ...
    assert get_logger.mock_calls[0].args == ("avi_challenge_lab",)
...
def test_initialize_logging_user_defined_config(get_logger, basic_cfg):
    ...
    avi_challenge_lab.log.initialize_logging(config=config)
...
def test_initialize_logging_filename(get_logger, basic_cfg):
    ...
    avi_challenge_lab.log.initialize_logging(filename="output.log")
